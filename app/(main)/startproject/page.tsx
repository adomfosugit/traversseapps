...
const  page = async (props: Props) => {
  ...
  return (
    <div className='flex flex-col mx-auto max-w-4xl justify-center items-center gap-y-5  py-3 lg:py-12'>
        <h1 className='  items-center justify-center text-center text-primary '> Hello  <span className='text-primary font-old m-2'>{getUser.name}</span>Choose the pathway that best suit your property acquisition journey</h1>
