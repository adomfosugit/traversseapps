...
>
  Projects
    ...
    <NavigationMenuItem>
      <NavigationMenuLink href='/dashboard/Profile' className={`${navigationMenuTriggerStyle()} hover:bg-primary hover:text-white ${pathname === '/dashboard/Profile' ? 'bg-primary text-white' : ''}`}  >Profile</NavigationMenuLink>
    </NavigationMenuItem>
