    ...
    <div>
                ...
                <DialogContent className='py-5'>
                  <DialogHeader>
                    ...
                    <p>Please carefully review all submitted documents.  If you are satisfied with the information provided,  click <strong>Proceed</strong> to give your consent and move to the Registration stage.</p>
