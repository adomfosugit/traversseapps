...
export function ConsentSubForm({ JobProjectID }: { JobProjectID: string }) {
    ...
    try {
      ...
      if (updateResult) {
        toast({
          ...
          description: "Consent document uploaded successfully",
        })
        form.reset()
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-lg border">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">
          Upload your Consent form document
        </p>
      </div>
            ...
            render={({ field: { onChange, ...rest } }) => (
              <FormItem>
                ...
                <FormDescription className="text-sm text-gray-600">
                  Upload a PDF document or image file containing the Consent form.
