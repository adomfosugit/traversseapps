...
const LandModal = () => {
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <ModalHeader
        title="What is the zoning and interest type of your land"
  ...
  if (step === STEPS.INFO) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        ...
        <hr />
        <Counter
          title="Adjoining lands"
          subtitle="How many adjoining lands do you have?"
          value={otherLands}
          onChange={(value) => setCustomValue('otherLands', value)}
        />
      </div>
    );
  }
