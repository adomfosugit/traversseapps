...
export function OathofProofForm({ JobProjectID }: { JobProjectID: string }) {
    ...
    try {
      ...
      if (updateResult) {
        toast({
          ...
          description: "Oath of Proof document uploaded successfully",
        })
        form.reset()
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-lg border">
      <div className="mb-6">
        <h2 className="font-semibold text-primary mb-2">
          Oath of Proof Document
        </h2>
        <p className="text-gray-600 text-sm">
          Upload your Oath of Proof form document
        </p>
      </div>
            ...
            render={({ field: { onChange, ...rest } }) => (
              <FormItem>
                ...
                <FormDescription className="text-sm text-gray-600">
                  Upload a PDF document or image file containing the Oath of Proof form.
